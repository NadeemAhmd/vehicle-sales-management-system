	...
	<!--	<div class="row">
		...
		<div class="row">
							...
							<div class="form-group">
								Security Question : 
									<select class="form-control" placeholder="Security Question" name="s_question">
										  <option value="What is your 1st Phone No?">What is your DBMS teacher name?</option>
										  <option value="Who is your 1st teacher?">What is your Fb password?</option>
										  <option value="Who do you prise?">Is Oxford college good?</option>
									</select>
							</div>
							<div class="form-group">
								Answer: <input class="form-control" placeholder="Answer" name="s_ans" type="text" required>
							</div>
							<div class="form-group">
								User Type: 
			...
			<div class="col-lg-7 col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading">All Users are Listed Below! </div>
					<div class="panel-body">
