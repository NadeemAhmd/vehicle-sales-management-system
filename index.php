...
<nav class="navbar navbar-inverse navbar-fixed">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	  ...
	  <li><a href="show_tables.php">Database Schema<span class="sr-only">(current)</span></a></li>
	  <li><a href="sql.php">Database Table<span class="sr-only">(current)</span></a></li>
...
<h1 class="text-uppercase" style="color:;"> <u>VEHICLE SALES MANAGEMENT SYSTEM</u><h1>
...
<p style="color:cyan;"> <u>&copy Project by Nadeem . All right reseved.</u></p>
</div>
</body>
</html>