...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-6">
			...
			<img src="login/uploads/<?php $path=explode("*",$Row['image']); echo $path[0]; ?>" width="250" height="250">
			</div>
		...
		<div class="col-md-4">
			...
			<p> Invoice ID :  <?php echo $Row['invoice_id']; ?></p>
			<p> Warranty Left :  <?php echo $wleft; ?> Days</p>
			<p> Warranty End date :  <?php echo $Row['w_end']; ?></p>
